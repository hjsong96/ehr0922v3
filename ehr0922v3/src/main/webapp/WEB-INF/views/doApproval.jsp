...
<!-- 모달 end -->
<!-- 보드 start -->
<h2 class="card-title" style="text-align: center; padding-right: 20px;">결재 하기</h2>
<div class="card">
          <div class="table-responsive">
              <table class="table">
         ...
         <div class="page-div">
            <c:if test="${ph.showPrev}">
               <button class="page" onclick="location.href='./doApproval?page=${ph.startPage-1}'">이전</button>
            </c:if>
            <c:forEach var="i" begin="${ph.startPage}" end="${ph.endPage}">
               <a onclick="pageCss()" href="<c:url value='./doApproval?page=${i}&pageSize=${ph.pageSize}'/>">${i}</a>
            </c:forEach>
            <c:if test="${ph.showNext}">
               <button class="page" onclick="location.href='./doApproval?page=${ph.endPage+1}'">다음</button>
            </c:if>
         </div>
         <!-- 페이징 end -->
